...
- Fixed PDF Access 401 Error (Cloudinary Versioning issue fixed in code)
- NOTE: Cloudinary "PDF and ZIP files delivery" MUST be enabled in Account Settings > Security for PDFs to work.
